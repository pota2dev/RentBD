...
export type EmailLogWhereInput = {
  ...
  emailLogId?: Prisma.StringFilter<"EmailLog"> | string
  ...
  status?: Prisma.StringNullableFilter<"EmailLog"> | string | null
...
export type EmailLogScalarWhereWithAggregatesInput = {
  ...
  emailLogId?: Prisma.StringWithAggregatesFilter<"EmailLog"> | string
  ...
  status?: Prisma.StringNullableWithAggregatesFilter<"EmailLog"> | string | null
...
export type EmailLogOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"emailLogId" | "userId" | "type" | "recipient" | "subject" | "body" | "status" | "sentAt", ExtArgs["result"]["emailLog"]>
...
export interface EmailLogDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `emailLogId`
   * const emailLogWithEmailLogIdOnly = await prisma.emailLog.findMany({ select: { emailLogId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many EmailLogs and only return the `emailLogId`
   * const emailLogWithEmailLogIdOnly = await prisma.emailLog.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more EmailLogs and only return the `emailLogId`
   * const emailLogWithEmailLogIdOnly = await prisma.emailLog.updateManyAndReturn({
   *   select: { emailLogId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface EmailLogFieldRefs {
  readonly emailLogId: Prisma.FieldRef<"EmailLog", 'String'>
