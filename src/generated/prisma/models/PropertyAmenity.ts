...
export type PropertyAmenityWhereInput = {
  ...
  amenityName?: Prisma.StringFilter<"PropertyAmenity"> | string
  amenityType?: Prisma.StringNullableFilter<"PropertyAmenity"> | string | null
...
export type PropertyAmenityOrderByWithRelationInput = {
  ...
  amenityName?: Prisma.SortOrder
  amenityType?: Prisma.SortOrderInput | Prisma.SortOrder
...
export type PropertyAmenityScalarWhereWithAggregatesInput = {
  ...
  amenityName?: Prisma.StringWithAggregatesFilter<"PropertyAmenity"> | string
  amenityType?: Prisma.StringNullableWithAggregatesFilter<"PropertyAmenity"> | string | null
}
...
export type PropertyAmenityUpdateInput = {
  ...
  amenityName?: Prisma.StringFieldUpdateOperationsInput | string
  amenityType?: Prisma.NullableStringFieldUpdateOperationsInput | string | null
...
export type PropertyAmenityOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"amenityId" | "propertyId" | "amenityName" | "amenityType", ExtArgs["result"]["propertyAmenity"]>
...
export interface PropertyAmenityDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const propertyAmenityWithAmenityIdOnly = await prisma.propertyAmenity.findMany({ select: { amenityId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many PropertyAmenities and only return the `amenityId`
   * const propertyAmenityWithAmenityIdOnly = await prisma.propertyAmenity.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more PropertyAmenities and only return the `amenityId`
   * const propertyAmenityWithAmenityIdOnly = await prisma.propertyAmenity.updateManyAndReturn({
   *   select: { amenityId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PropertyAmenityFieldRefs {
  ...
  readonly amenityName: Prisma.FieldRef<"PropertyAmenity", 'String'>
  readonly amenityType: Prisma.FieldRef<"PropertyAmenity", 'String'>
}
