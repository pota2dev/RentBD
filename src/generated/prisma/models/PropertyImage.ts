...
export type PropertyImageWhereInput = {
  ...
  imageId?: Prisma.StringFilter<"PropertyImage"> | string
  ...
  displayOrder?: Prisma.IntNullableFilter<"PropertyImage"> | number | null
...
export type PropertyImageScalarWhereWithAggregatesInput = {
  ...
  imageId?: Prisma.StringWithAggregatesFilter<"PropertyImage"> | string
  ...
  displayOrder?: Prisma.IntNullableWithAggregatesFilter<"PropertyImage"> | number | null
...
export type PropertyImageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"imageId" | "propertyId" | "imageUrl" | "thumbnailUrl" | "displayOrder" | "isPrimary" | "uploadedAt", ExtArgs["result"]["propertyImage"]>
...
export interface PropertyImageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const propertyImageWithImageIdOnly = await prisma.propertyImage.findMany({ select: { imageId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many PropertyImages and only return the `imageId`
   * const propertyImageWithImageIdOnly = await prisma.propertyImage.createManyAndReturn({
   *   select: { imageId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more PropertyImages and only return the `imageId`
   * const propertyImageWithImageIdOnly = await prisma.propertyImage.updateManyAndReturn({
   *   select: { imageId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PropertyImageFieldRefs {
  readonly imageId: Prisma.FieldRef<"PropertyImage", 'String'>
